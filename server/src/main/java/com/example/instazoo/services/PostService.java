...
public class PostService {
    ...
    public Post likePost(Long postId, String username) {  // Есть ли в списке лайкнувших наш пользователь
    ...
    public void deletePost(Long postId, Principal principal) {  // Валидация, является ли пост чьим то конкретным. МОдет он хочет удалить чужой пост.
